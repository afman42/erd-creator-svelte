...
// TestMariaDBJunctionRoundTrip: a many-to-many junction — composite PK over
...
// lost on reopen.
func TestMariaDBJunctionRoundTrip(t *testing.T) {
	s := &Schema{Dialect: DialectMariaDB, Tables: []Table{
