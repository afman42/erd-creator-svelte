...
// All four dialects have parsers, so their files reopen: mysql and mariadb
// share one, postgres and sqlite have their own.
...
func (s *Schema) GenSQL() (string, error) {
	...
	case DialectPostgres:
		out = buildPostgres(s.Tables)
	case DialectMariaDB:
		out = buildMariaDB(s.Tables)
	case DialectSqlite:
		out = buildSqlite(s.Tables, s.sqliteTypesMode())
	default:
		out = buildMysql(s.Tables, "-- Generated by erd-creator")
	}
