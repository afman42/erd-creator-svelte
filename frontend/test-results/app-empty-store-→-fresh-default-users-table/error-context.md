...
- Name: app.spec.js >> empty store → fresh default users table
- Location: e2e/app.spec.js:16:1
...
Locator: locator('.tname')
Expected: "users"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveValue" locator('.tname') with timeout 5000ms
  - waiting for locator('.tname')
